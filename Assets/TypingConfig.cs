    ...
    public static List<TypingLine> GetTypingConfig(string scenario)
    {
        switch (scenario)
        {
            ...
            case "LevelTwo":
                ...
                LevelTwoConfig.Add(new TypingLine(entity: "Enemy", textToType: "You can outtype a full block, but so what? Let's see how you do against my barrage attack!", timeAllowed: 2.0));
