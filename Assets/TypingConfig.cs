    ...
    public static List<TypingLine> GetTypingConfig(string scenario)
    {
        switch (scenario)
        {
            case "LevelOne":
                ...
                LevelOneConfig.Add(new TypingLine(entity: "Enemy", textToType: "You're a terrible employee! I've kept you trapped in your position for years, hoping that one day you’d quit on your own so that I didn’t have to deal with you anymore! " +
